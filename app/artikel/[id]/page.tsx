...
const articles = [
    {
      ...
      references : "https://aceh.tribunnews.com/2023/08/15/kisah-gustavian-usia-26-tahun-sukses-bisnis-budidaya-lele-omzet-capai-rp-500-juta-per-bulan",
    },
    {
      id: "2",
      ...
      references : "https://www.minapoli.com/info/pakan-ikan-lele-cepat-besar-jenis-kebutuhan-nutrisi-dan-cara-pembuatan",
    },
    {
      id: "3",
      ...
      references : "https://www.pasarmikro.id/buletin/panduan-budidaya-ikan-lele-untuk-pemula/",
    },
  ];
...
export default function DetailArtikelPage({ params }: DetailArtikelPageProps) {
  ...
  return (
    <div className="p-6 max-w-3xl mx-auto">
      <Link href="/pond" className="text-primary-600 flex items-center space-x-2 mb-4">
        <span>&#8592; Kembali</span>
      </Link>
